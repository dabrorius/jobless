...
CVML.create do
  ...
  employment do
    ...
    entry do
      ...
      description "Helping design and develop new features. Created an interface for bulk editing records similar to excel spreadsheet. Technologies: Ruby on Rails, Javascript, jQuery"
    ...
    entry do
      ...
      company "CampWire"
      technologies "Ruby, Ruby on Rails, Javascript"
      description "I created a working payment system with Stripe. Wrote a full test suite for existing application. Maintained and refactored existing code. Introduced new developers to the application."
  ...
  open_source do
    ...
    entry do
      ...
      description "Markov noodles is a minimalistic library for generating text using Markov chains."
    end
    entry do
      title "grape"
      homepage "https://github.com/ruby­grape/grape"
      description "I am a contributer to grape an opinionated micro­framework for creating REST­like APIs in Ruby."
    end
    entry do
      title "CatMe iOS App"
      homepage "https://itunes.apple.com/us/app/id994659934"
      description "CatMe is a simple native mobile app that allows you to virtually pet cats! Move your finger over a cat photo and you will hear it purr. It's free, ad­free and completely useless."
    end
  end
